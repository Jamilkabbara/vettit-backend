...
router.post('/generate-survey', authenticate, async (req, res, next) => {
  try {
...
router.post('/refine-question', authenticate, async (req, res, next) => {
  try {
...
router.post('/refine-description', authenticate, async (req, res, next) => {
  try {
...
router.post('/suggest-targeting', authenticate, async (req, res, next) => {
  try {
